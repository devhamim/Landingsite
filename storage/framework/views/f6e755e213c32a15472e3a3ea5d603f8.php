                                    ...
                                    <table class="table table-summary table-responsive">
                                        ...
                                        <tbody class="mt-5">
                                                ...
                                                <tr class="table-shadow">
                                                    ...
                                                    <td>
                                                        <div class="product_info">
                                                            <p><a style="font-weight: 500;" href="<?php echo e(route('product.details', $data['item_slug'])); ?>"><?php echo e(urldecode($data['item_name'])); ?></a></p>
                                                            <?php if(isset($data['item_weight']) && $data['item_weight'] !== null): ?>
                                                                <span>Package: <?php echo e($data['item_weight']); ?></span>
                                                            <?php endif; ?>
                                                    ...
                                                    <td>
                                                        <span class="product-price" style="display: inline">
                                                            <?php echo e(isset($data['item_price']) ? $data['item_price'] : $data['product_price']); ?>

                                                        </span> Tk X
                                                    </td>
                                                    <td class="ps-3 text-center mt-2 pro_details_ico" style="padding-top: 15px; justify-content: center; width: 10%; margin: 0 auto">
                                                        <input type="number" name="quantity[<?php echo e($data['item_id']); ?>]" class="qty-input form-control" value="<?php echo e($data['item_quantity']); ?>" min="1" max="100" step="1" data-decimals="0" required>
                                                    </td>
                                                    <td>
                                                        <div class="cart-product-quantity">
                                                            <input type="hidden" class="product-id" value="<?php echo e($data['item_id']); ?>">
                                                            <span class="subtotal"><?php echo e(($data['item_quantity'] ?? 1) * ($data['item_price'] ?? $data['product_price'])); ?> Tk</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
                                            ...
                                            <tr class="summary-total checkout_bottom_border">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="grand_total_price"><?php echo e($total); ?> Tk</td>
                                            </tr>
                                            ...
                                            <tr class="summary-total delivery-charge-row checkout_bottom_border">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td class="grand_total"><span class="grand_span"><?php echo e($total); ?> Tk</span></td>
                                            </tr>
                            ...
                            <div class="col-lg-5 checkout_form">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="আপনার নাম লিখুন" required="" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="tel" name="mobile" class="form-control" placeholder="আপনার মোবাইল নাম্বারটি লিখুন" required="" value="<?php echo e(old('mobile')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" name="address" placeholder="সম্পূর্ণ ঠিকানা" class="form-control" required="" value="<?php echo e(old('address')); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>নির্দেশনা</label>
                                        <input type="text" name="note" placeholder="নির্দেশনা" class="form-control" value="<?php echo e(old('note')); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/cottonbd.nitebiz.com/resources/views/frontend/checkout.blade.php ENDPATH**/ ?>