                            ...
                            <tbody>
                                <?php $__currentLoopData = $subcategorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($subcategory->category_id != null): ?>
                                                <?php if($subcategory->rel_to_cat != null): ?>
                                                    <?php echo e($subcategory->rel_to_cat->name); ?>
                                        ...
                                        <td>
                                            <div class="btn-group mb-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editSubcategory<?php echo e($subcategory->id); ?>">
                                                        Edit
                                                    </button>
                                                    <form action="<?php echo e(route('subcategorys.destroy',  $subcategory->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal fade modal-add-contact" id="editSubcategory<?php echo e($subcategory->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <form action="<?php echo e(route('subcategorys.update', $subcategory->id)); ?>" method="POST" enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($subcategory->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <select name="status" id="status" class="form-control">
                                                                        ...
                                                                        <option value="0"<?php echo e($subcategory->status == 0?'selected':''); ?>>Deactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade modal-add-contact" id="addSubcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="<?php echo e(route('subcategorys.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header px-4">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/cottonbd.nitebiz.com/resources/views/backend/subcategory.blade.php ENDPATH**/ ?>