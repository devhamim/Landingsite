                        ...
                        <figure class="product-media">
                            ...
                            <div class="text-center">
                                <form action="#" method="POST">
                                    ...
                                    <a href="<?php echo e(route('product.details', $product->slug)); ?>" class="btn-product btn-cart btn-buy mr-5 w-100" name="btn" value="2"><span>অর্ডার করুন</span></a>
                                </form>
                            </div>
                        </figure>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nitebiz/cottonbd.nitebiz.com/resources/views/frontend/shop.blade.php ENDPATH**/ ?>