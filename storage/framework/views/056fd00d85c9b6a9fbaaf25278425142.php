                            ...
                            <?php $__currentLoopData = $order_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span style="">Color:<?php echo e($orders->color); ?> <span>, Size:<?php echo e($orders->size); ?>, </span></span>
                                        </td>
                                        <td><?php echo e(number_format($order->price)); ?> X <?php echo e($order->quantity); ?></td>
                                        <td><?php echo e(number_format(($order->price))); ?> TK</td>
                                    </tr>
                                    <?php
...
<?php /**PATH /home/nitebiz/cottonbd.nitebiz.com/resources/views/invoice/print_invoice.blade.php ENDPATH**/ ?>